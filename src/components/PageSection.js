            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-20 lg:flex lg:items-center lg:justify-between">
                ...
                <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0 items-center object-center justify-center">
                    <div className="inline-flex rounded-md shadow">
                        ...
                        <a
                            className="mx-2 inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-sky-600 hover:bg-sky-500 w-32"
                        ...
                        <a
                            className="mx-2 inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-sky-400 bg-slate-800 hover:bg-slate-700 w-32"
